  ...
  >
    ...
    <div class="border-t border-edge p-3">
      <div class="flex items-center gap-3">
        <!-- User Avatar -->
        <div class="w-8 h-8 rounded-full bg-accent/20 flex items-center justify-center text-accent font-medium">
          {{ authStore.user?.name?.charAt(0) || authStore.user?.username?.charAt(0) || 'U' }}
        </div>
        <div v-if="sidebarStore.isExpanded" class="flex-1 min-w-0">
